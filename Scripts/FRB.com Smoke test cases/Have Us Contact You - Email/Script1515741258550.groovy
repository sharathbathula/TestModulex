...
WebUI.click(findTestObject('FRB.com Smoke test/Have Us Contact You/label_Email'))

WebUI.setText(findTestObject('FRB.com Smoke test/Have Us Contact You/input_Email'), 'abc@gmail.com')
